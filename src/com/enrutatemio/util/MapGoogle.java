...
public class MapGoogle {
	...
	public MapGoogle(Fragment activity, ShowMapActivity showMapActivity) {
		this.showMapActivity = showMapActivity;
		
		map = ((SupportMapFragment) activity.getChildFragmentManager()
				.findFragmentById(R.id.mapviewvdos)).getMap();
		if (map != null) {
	...
	public void setInfoWindowClickListener(OnInfoWindowClickListener listener) {
	...
	public void hideFunctionsMap() {
		Visibility.gone(showMapActivity.viewMapa);
	...
	//	showMapActivity.change_travel.clearAnimation();
		//Visibility.gone(showMapActivity.change_travel);
	}
